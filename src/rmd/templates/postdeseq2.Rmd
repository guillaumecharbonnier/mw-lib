...
if ("hugo_symbol" %in% colnames(r)) {
  ...
  if (length(dereg_genes) == 0) {
    ...
    # suppressWarning for 
    ## Warning in urls_items$enrichr_dereg_genes <- paste0("* Enrichr results for all
    ## deregulated genes are available [here](", : Coercing LHS to a list
    urls_items$enrichr_dereg_genes <- suppressWarnings(paste0(
