...
ID_BAM_TO_BED = "bedtools/bamtobed|awk/extend_reads_[0-9]+/bedtools/bamtobed|awk/convert_bedpe_to_bed6_insert_size/bedtools/bamtobed_bedpe/samtools/sort_n|awk/extend_reads_[0-9]+/awk/keep_first_mate_for_pe_bedtools_bamtobed/bedtools/bamtobed"
...
rule capstarrseq_coverage_fpkm_input:
    ...
    input:
        ...
        bed_crms="out/sort/coordinates_bed/inp/bed/crms/{crm_type}.bed",
        flagstat="out/{id}.flagstat.txt"
    output:
...
rule capstarrseq_merge_all_data:
    ...
    Test:
        ...
        out/capstarrseq/grouping_crms/capstarrseq/fold_change_mTDHS/awk/extend_reads_314/bedtools/bamtobed/ln/sst_exp/CapStarr_155_170_178_204/mm9/mT_DHS_PGK_P5424_stimulated_rep3_over_mT_DHS_PGK_input.inflexionPointGroups.tsv
    out/capstarrseq/merge_all_data_mTDHS/awk/extend_reads_314/bedtools/bamtobed/ln/sst_exp/CapStarr_155_170_178_204/mm9/mT_DHS_PGK_P5424_stimulated_rep3_over_mT_DHS_PGK_input.allData.tsv
    """
    input:
