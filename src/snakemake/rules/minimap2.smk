rule minimap2_ext:
    ...
    Test:
        out/minimap2/fasta_fa-genome-GRCh38-ensembl-r100/megahit/pe/sickle/pe_-t_sanger_-q_30/ln/alias/sst/all_samples/fastq/PEER_Crispr_5-10_Chip_H3K27ac/final.contigs.sam
    """
    input:
        fa_to_align = "out/{filler}.{ext}",
        fa_genome = lambda wildcards: eval(mwconf['ids'][wildcards.fa_genome_id])
    output:
        sam = "out/{tool}{extra}_{fa_genome_id}/{filler}.sam"
    log:
